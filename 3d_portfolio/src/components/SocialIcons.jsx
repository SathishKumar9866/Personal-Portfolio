/**
 * Owns: the clickable icon row for every off-site profile.
 * Does not own: the addresses themselves — those live in constants/index.js.
 *
 * Inline SVG rather than an icon dependency: four marks do not justify a
 * package, and brand paths never change.
 */
