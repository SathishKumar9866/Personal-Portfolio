    ...
    {socialLinks().map((l) => (
      <li key={l.k}>
        <a
          ...
          aria-label={l.label}
          title={l.label}
          className="flex items-center justify-center rounded-lg border border-line-strong p-3 sm:p-2.5 text-secondary hover:text-accent hover:border-accent transition-colors"
        >
          <svg
            width={size}
            height={size}
