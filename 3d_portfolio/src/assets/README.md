...
These are leftovers from the original 3D template this repo was forked from —
the one the `3d_portfolio` folder name still refers to, and whose three.js stack
